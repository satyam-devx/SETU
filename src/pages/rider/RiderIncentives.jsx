              ...
              return (
                <Card key={inc.id} className="p-4 border-border">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <Badge className={`border-0 text-xs shrink-0 ${done ? 'bg-primary/5 text-primary' : 'bg-green-100 text-green-700'}`}>
          ...
          <div className="grid grid-cols-3 gap-3">
            {badgeDisplay.map(b => (
              ...
              >
                ...
                {b.earned && (
                  <Badge className="text-[8px] mt-1 bg-primary/5 text-primary border-0">Earned</Badge>
                )}
              </Card>
            ))}
          </div>
