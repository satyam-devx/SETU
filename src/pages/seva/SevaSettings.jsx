        ...
        <Card className="border-border divide-y divide-border">
          <div className="flex items-center justify-between p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-sm font-medium block">Job Notifications</span>
                <span className="text-xs text-muted-foreground">Get alerts for new job requests</span>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-sm font-medium block">Availability Status</span>
                <span className="text-xs text-muted-foreground">Show as available for jobs</span>
              </div>
            </div>
        ...
        <Card className="border-border p-4 space-y-3">
          ...
          <div className="flex gap-2">
            {['2 km', '5 km', '10 km', '15 km'].map(r => (
              <button key={r} className="text-xs px-3 py-1.5 rounded-full border border-border bg-card hover:border-primary transition-colors">
                {r}
              </button>
            ))}
          </div>
