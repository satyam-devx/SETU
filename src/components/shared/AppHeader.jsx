      ...
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2 min-w-0 flex-1">
          {showBack && (
            <button
              onClick={handleBack}
              className="-ml-1 w-11 h-11 rounded-lg flex items-center justify-center text-foreground hover:bg-muted transition-colors shrink-0"
              aria-label="Go back"
            >
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          {notificationCount > 0 && (
            <Link
              to={notificationPath}
              className="relative w-11 h-11 rounded-lg flex items-center justify-center text-muted-foreground hover:bg-muted transition-colors"
